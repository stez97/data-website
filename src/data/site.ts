...
export const contact = {
  addressLine1: "Calle Avenida Samuel Lewis,",
  addressLine2: "Ciudad de Panamá, Panamá.",
  phone: "+507 6905-3902",
  phoneHref: "tel:50769053902",
  email: "info@dacat-sa.com",
  emailHref: "mailto:info@dacat-sa.com",
};

export const products = [
  {
    name: "DACAT CONDY",
    image: "/images/dacat/product-condy.png",
  ...
  {
    name: "DACAT CONDY DUO",
    image: "/images/dacat/product-condy-duo.png",
  ...
  {
    name: "DACAT CONDY PRO",
    image: "/images/dacat/product-condy-pro.png",
    href: "https://www.dacat-sa.com/condy-pro/",
    description:
      "DACAT CONDY PRO es una tubería de cobre preaislada de alto rendimiento, diseñada para aplicaciones HVAC/R y sistemas de refrigeración que requieren máxima protección y durabilidad incluso en condiciones exteriores exigentes. Gracias a su aislamiento especial resistente a los rayos UV y agentes atmosféricos, ofrece una protección superior contra exposición solar, humedad, desgaste y condiciones ambientales adversas. El aislamiento extruido directamente sobre el cobre garantiza excelente adherencia, mayor resistencia mecánica y una larga vida útil. DACAT CONDY PRO representa una solución profesional, confiable y eficiente para instalaciones residenciales, comerciales e industriales donde la calidad y la resistencia son fundamentales.",
  },
];
